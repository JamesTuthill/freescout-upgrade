	...
	<form class="form-horizontal" method="POST" action="">
		...
		<div>
	        <div class="col-md-11 col-md-offset-1">
	            <div class="thread-attachments sr-attachments-upload attachments-upload form-group">
	            	<ul>
	            	</ul>
                </div>
	        </div>
                ...
                <div class="controls">
                    <div class="onoffswitch-wrap">
                        <div class="onoffswitch">
                            <input type="checkbox" name="global" value="1" id="sr_global" class="onoffswitch-checkbox">
                            <label class="onoffswitch-label" for="sr_global"></label>
                        </div>
                    </div>
                </div>
            </div>
