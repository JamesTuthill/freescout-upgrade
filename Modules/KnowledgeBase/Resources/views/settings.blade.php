...
<div class="col-xs-12">
    ...
    <form class="form-horizontal margin-top margin-bottom-30" method="POST" action="" autocomplete="off" enctype="multipart/form-data">
        {{ csrf_field() }}
        ...
        <div>
            <h3 class="subheader">{{ __('Import Tool') }}</h3>
        </div>

        <div class="form-group">
            <label class="col-sm-2 control-label">{{ __('Overwrite or amend knowledge base?') }}</label>

            <div class="col-sm-6">
                <select class="form-control" name="settings[overwriteOrAmmend]">
                    <option value="amend">Amend (Adds to existing knowledge base)</option>
                    <option value="overwrite">Overwrite (Deletes existing knowledge base)</option>
                </select>
            </div>
        </div>

        <div class="form-group">
            <label class="col-sm-2 control-label">{{ __('Upload CSV') }}</label>
        ...
        <div class="form-group margin-top">
            <div class="col-sm-6 col-sm-offset-2">
                <button type="submit" name="kb_action" value="save_import" class="btn btn-primary">
                    {{ __('Save') }}
                </button>
            </div>
        </div>
