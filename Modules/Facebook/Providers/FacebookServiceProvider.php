...
class FacebookServiceProvider extends ServiceProvider
{
    ...
    public static function processIncomingMessage($bot, $text, $mailbox, $files = [])
    {
        ...
        try {            
            ...
            // $messenger_user->getInfo() does not make any extra calls.
            ...
            $customer_info['email'] = '';
            $customer_info['profile_pic'] = $messenger_user->getProfilePic();
            $customer_info['username'] = $messenger_user->getUsername();
        ...
        // Set photo.
        if ($set_photo && !$customer->photo_url) {
