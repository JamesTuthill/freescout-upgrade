                ...
                <div class="col-xs-12">
                    ...
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane active" id="tab-settings">
                            ...
                            <div class="form-group{{ $errors->has('max_executions') ? ' has-error' : '' }} wf-type wf-type-auto  @if (old('type', $workflow->type) != Workflow::TYPE_AUTOMATIC) hidden @endif">
                                <label for="type" class="col-sm-2 control-label">{{ __('Max Executions') }}</label>

                                <div class="col-sm-8">
                                    <input class="form-control input-sized" name="max_executions" type="number" min="1" max="1000000" value="{{ old('type', $workflow->max_executions) }}" required autofocus>

                                    <p class="form-help">
                                        {{ __('Maximum executions per conversation.') }}
                                    </p>
