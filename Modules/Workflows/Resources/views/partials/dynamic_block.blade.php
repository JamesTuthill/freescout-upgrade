                                    ...
                                    @foreach ($row_config as $row_info)
                                        ...
                                        @endif
                                            @foreach ($row_info['items'] as $row_item_key => $row_item)
                                                <option value="{{ $row_item_key }}" @if (isset($row['type']) && $row_item_key == $row['type']) selected @endif @if ($mode == 'conditions' && $form_mode == 'create' && $row_item_key == 'channel' && empty($row_item['values'])) class="hidden" @endif>{{ $row_item['title'] }}</option>
                                            @endforeach
                                        @if (!empty($row_info['title']))
                                            </optgroup>
                                        @endif
